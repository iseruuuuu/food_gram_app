...
1. **Authentication Information**
   ...
   - Email address (when using Google/Apple authentication)
...
4. **Usage Information**
   ...
   - Post date and time, update date and time

5. **Device Information**
   - Device type, OS information (used for error reporting, etc.)
...
3. To send important notices to users
...
6. To allow users to view, change, delete their registered information, and view their usage status
...
4. When the following matters have been notified or published in advance, and the Company has filed a notification with the Personal Information Protection Commission:
   ...
   4. That provision of personal information to third parties will be stopped upon request of the person
...
1. **Supabase** (Database and Storage Service)
   ...
   - Purpose of use: Data storage and management

2. **Firebase** (Push Notification Service)
   - Information provided: User ID, device token
   - Purpose of use: Delivery of push notifications

3. **RevenueCat** (Subscription Management Service)
   - Information provided: User ID, purchase information
   - Purpose of use: Management of premium members

4. **Google Mobile Ads** (Advertising Service)
...
1. **Use of Tracking Technology**
   ...
   - For iOS 14.5 and later, tracking is performed only with the user's explicit consent through App Tracking Transparency (ATT)
