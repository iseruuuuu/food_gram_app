...
import 'package:food_gram_app/core/summary/monthly/monthly_summary_provider.dart';
...
class MonthlySummaryScreen extends HookConsumerWidget {
      ...
      body: Stack(
        children: [
                    ...
                    child: RepaintBoundary(
                      ...
                      child: ColoredBox(
                        ...
                        child: Padding(
                          ...
                          child: MonthlySummaryContent(summary: summary),
                        ),
                      ),
                    ),
                  ),
          ...
          AppProcessLoading(
            ...
            status: t.monthlySummary.shareLoading,
          ),
        ],
      ),
    );
  ...
  Future<void> _share({
    ...
    await ShareHelpers().captureBoundaryAndShare(
      ...
      loading: loading,
      hasText: true,
      shareText: t.monthlySummary.shareText.replaceAll(
        '{month}',
        '${summary.period.monthStart.month}',
      ),
      errorMessage: t.monthlySummary.shareError,
    );
  }
}
