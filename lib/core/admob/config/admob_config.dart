...
class AdmobConfig {
  ...
  // テスト用広告ID
  static const _testIds = _TestAdIds(
  ...
  static String get appOpenAdUnitId {
    if (_isTest) {
      return Platform.isAndroid
          ? _testIds.android.appOpen
          : _testIds.ios.appOpen;
    }
    return Platform.isAndroid ? Env.androidOpen : Env.iOSOpen;
  }

  // 広告の表示間隔
  static const Duration minInterstitialDuration = Duration(minutes: 3);
  static const Duration minAppOpenDuration = Duration(minutes: 5);
}
