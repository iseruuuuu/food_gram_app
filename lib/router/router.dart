...
import 'package:food_gram_app/ui/component/common/router_error_widget.dart';
...
final weeklySummaryRoute = GoRoute(
  path: RouterPath.weeklySummary,
  name: RouterPath.weeklySummary,
  pageBuilder: (context, state) {
